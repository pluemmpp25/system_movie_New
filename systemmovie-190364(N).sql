...
--
-- Host: localhost
-- Generation Time: Mar 19, 2021 at 08:33 AM
...
(4, 'mv3234', 25, '2021-03-13', '21:00:00', 0),
(123463, 'mv4234', 50, '2021-02-25', '22:13:00', 0),
(123465, 'abc', 1000, '2021-03-19', '22:00:00', 0),
(123477, 'mv1234', 50, '2021-03-05', '13:42:00', 0),
(123500, 'ttt', 35, '2021-03-11', '12:43:00', 0);
...
(5, '2021-03-17', '21:45:00', 80, 125, 1, 1),
(46, '2021-03-18', '11:30:00', 100, 150, 2, 3),
(47, '2021-03-19', '15:00:00', 100, 180, 2, 7),
(51, '2021-03-26', '16:58:00', 100, 150, 1, 7);
...
CREATE TABLE `ticket` (
  ...
  `code_id` int(11) NOT NULL COMMENT 'รหัสโค้ตส่วนลด',
  `tk_date` date NOT NULL COMMENT 'วันที่จอง',
  `u_id` int(11) NOT NULL COMMENT 'รหัสสมาชิก'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `ticket` (`tk_id`, `tk_payment`, `tk_status`, `tk_seat`, `time_id`, `code_id`, `tk_date`, `u_id`) VALUES
(33, 150, 'พร้อมใช้งาน', 'E4', 51, 123463, '2021-03-02', 1002),
(34, 80, 'พร้อมใช้งาน', 'B5', 5, 0, '2021-03-02', 1002),
(35, 70, 'พร้อมใช้งาน', 'B4', 46, 123465, '2021-03-02', 1008),
(36, 80, 'พร้อมใช้งาน', 'C3', 5, 0, '2021-03-05', 1002),
(37, 125, 'พร้อมใช้งาน', 'D5', 46, 4, '2021-03-05', 1002),
(38, 75, 'พร้อมใช้งาน', 'E5', 5, 123477, '2021-03-05', 1002),
(39, 80, 'พร้อมใช้งาน', 'C4', 5, 0, '2021-03-07', 1002),
(40, 75, 'พร้อมใช้งาน', 'E4', 5, 123477, '2021-03-08', 1002),
(41, 130, 'พร้อมใช้งาน', 'E4', 47, 123477, '2021-03-08', 1002);
...
--
ALTER TABLE `discountcode`
  MODIFY `code_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสโค้ตส่วนลด', AUTO_INCREMENT=123505;

--
-- AUTO_INCREMENT for table `moviename`
--
ALTER TABLE `moviename`
  MODIFY `name_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหนัง', AUTO_INCREMENT=22;
...
--
ALTER TABLE `movietime`
  MODIFY `time_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรอบฉาย', AUTO_INCREMENT=56;
...
--
ALTER TABLE `ticket`
  MODIFY `tk_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสตั๋ว', AUTO_INCREMENT=42;
